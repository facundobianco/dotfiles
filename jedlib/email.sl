...
static variable color_url = "normal";
static variable color_email = "keyword";
static variable color_signature = "comment";
static variable color_reply = "keyword3";
static variable color_smiley = "normal";
static variable color_bold = "normal";
...
dfa_define_highlight_rule ("^>.*",color_reply,mode);
...
static define reformat_quote()
{
   ...
   % reformat
   variable wrap = WRAP;
   WRAP=67 - strlen(strreplace(quotes, "\t", "        ", qlen), pop);
   call("format_paragraph");
   WRAP = wrap;
   % requote
